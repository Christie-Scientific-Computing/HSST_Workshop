...
We will be using pre-built segmentation models from the [segmentation-models](https://github.com/qubvel/segmentation_models.pytorch) package. You can design your own model, but for the sake of simplicity, we will implement an existing architecture.
